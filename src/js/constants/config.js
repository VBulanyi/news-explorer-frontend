const config = {
  ...
  login: 'https://api.news2explorer.tk/signin',
  signup: 'https://api.news2explorer.tk/signup',
  logout: 'https://api.news2explorer.tk/logout',
  getUser: 'https://api.news2explorer.tk/users/me',
  articles: 'https://api.news2explorer.tk/article',
